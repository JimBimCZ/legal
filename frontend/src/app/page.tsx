  ...
  return (
    <div className="flex flex-1 flex-col bg-zinc-50 dark:bg-black">
      <header className="border-b border-zinc-200 bg-white px-6 py-5 dark:border-zinc-800 dark:bg-zinc-950">
        <div className="mx-auto max-w-6xl">
          ...
          <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
            Chat with the AI assistant or fill in the details below to generate a Mutual
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-8 px-6 py-8">
        <section aria-labelledby="nda-chat-heading" className="flex flex-col gap-4">
          <h2 id="nda-chat-heading" className="text-sm font-semibold text-zinc-900 dark:text-zinc-50">
